...
screen_width = 1000
screen_height = 600
tank = Tank(400,200,40,40,"player_tank.png", 5)
fps = 60
...
while run:
    ...
    for collectable in collectables:
        ...
        if tank_rect.colliderect(collectable_rect):
            ...
            tank = Tank(tank.x,tank.y,60,60,"power up tank.png", 6,tank.angle)
            power_up = True
    ...
    if power_up_last >= 10:
        power_up = False
        tank = Tank(tank.x,tank.y,40,40,"player_tank.png", 5, tank.angle)
        power_up_last = 0
    pygame.display.flip()
    clock.tick(fps)
pygame.quit()